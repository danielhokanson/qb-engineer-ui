...
import { PartVendorStepComponent } from './part-vendor-step.component';
...
describe('PartVendorStepComponent (Phase 5 — save-on-Continue)', () => {
  let httpMock: HttpTestingController;
  let workflowService: WorkflowService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PartVendorStepComponent],
      providers: [
        provideHttpClient(),
  ...
  it('renders without errors when entity is null', () => {
    const component = TestBed.runInInjectionContext(() => new PartVendorStepComponent());
    mockSignalInputs(component, {
      stepId: 'vendor', componentName: 'PartVendorStepComponent',
